...
mongo_task = BashOperator(
    ...
    bash_command='python /opt/airflow/code/load_data_mongo_2.py',
    dag=dag
)
postgre_task = BashOperator(
         task_id='load_data_postgre',
         bash_command='python /opt/airflow/code/load_data_postgre_2.py',
         dag=dag
     )
postgre_task2 = BashOperator(
         task_id='Transformation',
         bash_command='python /opt/airflow/code/transformation_2.py',
         dag=dag
     )
