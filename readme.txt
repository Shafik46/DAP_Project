...
2. Create following directory 
	mkdir -p ./dags ./logs ./plugins ./code
...
9. EV_registration data is huge to pull through api. download that file and drop it in code folder in order to picked by airflow 
